...
import { Command, Settings, Palette, Keyboard, RotateCcw, AlertCircle, BookOpen, Command as CommandIcon, Search, Bot, Eye, EyeOff, CheckCircle, XCircle } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl p-4 border border-white/10 bg-white/[0.02]">
          ...
          <p className="text-white/40 text-xs mb-3">
            OpenAI 兼容填 <code className="text-white/30">/v1</code> 结尾；Ollama 填完整路径 <code className="text-white/30">/api/chat</code>
          </p>
          <input
            type="text"
            value={baseUrl}

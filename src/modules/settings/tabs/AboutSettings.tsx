    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl p-5 border border-white/10 bg-white/[0.02] flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500/30 to-violet-500/20 flex items-center justify-center flex-shrink-0 border border-white/10">
            <Command size={28} className="text-white/80" />
          </div>
          <div>
        ...
        <div className="rounded-xl p-4 border border-white/10 bg-white/[0.02]">
          ...
          <p className="text-white/45 text-xs leading-relaxed">
            Custom Tools 是一款面向 Windows 的效率工具启动器，提供应用模糊搜索、剪贴板历史、

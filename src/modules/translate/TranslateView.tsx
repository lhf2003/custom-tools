...
import { TARGET_LANG_OPTIONS, TARGET_LANG_KEY } from './constants';
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div className="ml-auto flex items-center gap-2">
            <select
              ...
              className="h-7 px-2 rounded-md text-xs bg-app-bg-elevated border border-app-border-subtle text-app-text-secondary outline-none focus:border-app-status-info/50 cursor-pointer"
              title="目标语言（同时作为划词翻译默认值）"
            >
